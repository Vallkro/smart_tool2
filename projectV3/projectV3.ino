...
#define LSM9DS1_SCK A17
#define LSM9DS1_MISO 12
#define LSM9DS1_MOSI A16
...
#define SPEED_3 8
#define SPEED_4 7
#define SPEED_5 1 // doesnt work proberly
#define REV_ON 0
#define HU 4
#define HW 2
#define HV 3
#define dataToSendLength 20
#define GEARBOX_RATIO 10
...
int interval = 5;            // One-second interval for measurements
...
void setup()
{
 ...
 // attachInterrupt(digitalPinToInterrupt(HU), updateEncoder, CHANGE);
...
void readNprintVolt() {
  ...
  // send voltage for display on SerialUSB Monitor
  // voltage multiplied by 11 when using voltage divider that
  // divides by 11. 11.132 is the calibrated voltage divide
  // value
  // SerialUSB.print(v1 * 11.132);
  // SerialUSB.println (" V");
}
void readOmega() {
